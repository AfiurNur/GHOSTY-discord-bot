...
class ass(commands.Cog):
    def __init__(self, bot):
        ...
        self.nsfw_ass_endpoint = "/nsfw/ass"  # NSFW ass endpoint


    def fetch_nsfw_ass_image(self):
        try:
            response = requests.get(f'{self.base_url}{self.nsfw_ass_endpoint}')
    ...
    @app_commands.command(name="nsfw_ass", description="Fetches an NSFW ass image")
    @app_commands.guilds(discord.Object(id=guild_id))
    async def nsfw_ass(self, interaction: discord.Integration):
        image_url = self.fetch_nsfw_ass_image()
        ...
        if interaction.channel and interaction.channel.nsfw:
            ...
            if image_url:
                embed = discord.Embed(
                    ...
                    description="Here is your requested NSFW ass image!",
